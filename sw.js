const CACHE='global-env-v2.9-config-joint-v1';
const TILE_CACHE='global-env-map-tiles-v1';
const SHELL=['./','./index.html','./manifest.webmanifest','./icons/app-icon.svg','./map-tier.js','./tiles/manifest.json','./assets/goldwind-logo.png','./assets/ui-engineering.css','./assets/ui-engineering.js','./assets/v29.css','./assets/v29-runtime-config.js','./assets/v29-config.js','./assets/v29-joint.js'];
